...
import 'VisitorSingleDetails.dart';

class VisitListDataView extends StatefulWidget {
  @override
  VisitListDataState createState() => VisitListDataState();
}

class VisitListDataState extends State<VisitListDataView> {
  ...
  return Card(
    child: InkWell(
      ...
      child: ListTile(
        onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => VistorSingle()));
        },
        onLongPress: () {
          print(values[index]);
        },
